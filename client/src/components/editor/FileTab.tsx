...
// Remove this import since the SettingContext is no longer available
...
function FileTab() {
    ...
    // Remove this line or use a fallback for setLanguage
    ...
    useEffect(() => {
        ...
        if (customMapping[extension]) {
            // Remove or replace with a fallback language setter
            // setLanguage(customMapping[extension])
            return
        }

        const language = langMap.languages(extension)
        // Replace with a fallback or mock language setter
